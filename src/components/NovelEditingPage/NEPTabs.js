...
import NEPTableContents from './NEPTableContents';
import NEPCommentsSmooth from './NEPCommentsSmooth.jsx'
import NEPProfiles from './NEPProfiles'
import NEPWorldMap from './NEPWorldMap'
...
export default function NEPTabs() {
